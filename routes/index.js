...
*/	
const SAMPLE_CARD = {heading:'Sample Item',img:'/favicon.png',content:`<p class="text-muted">This is a sample item with text and an optional price or button for more info.</p>`,footer:`<div class="text-center text-muted"><p>Price: <span class="text-success">$0.25</span></p><button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">More Details</button></div>`};
